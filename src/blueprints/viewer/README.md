...
- **Parts** outline (iOS-style disclosure groups, collapsed by default): Walls / Roof / Interior. Opacity sliders (0 = hidden; tap toggles 0 ↔ last non-zero). When any part is faded, all meshes use weighted blended OIT with DoubleSide; UI-100% meshes draw at α≈0.995 for that frame only. Leaving fade mode re-heals materials to the slider state. Camera presets (Iso / Front / Side / Top)
