...
- **Parts** outline (iOS-style disclosure groups, collapsed by default): Walls / Roof / Interior (recursive group tree). Opacity sliders on groups and leaves (0 = hidden; tap toggles 0 ↔ last non-zero). Camera presets (Iso / Front / Side / Top)
