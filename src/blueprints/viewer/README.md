...
- **Parts** outline (iOS-style disclosure groups, collapsed by default): Walls / Roof / Interior. Opacity sliders on groups and leaves (0 = hidden; tap toggles 0 ↔ last non-zero). Group slider proxies its leaves. Faded parts use normal alpha with depthWrite so nearer surfaces still occlude (no punch-through); you will not see through one faded layer to another until the front one is hidden. Camera presets (Iso / Front / Side / Top)
