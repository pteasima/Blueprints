...
- Part outline groups (Walls / Roof / Interior) with per-group and per-leaf **opacity** sliders (tap toggles 0 ↔ last value). Translucent parts use multi-pass **depth peeling** so faded layers composite correctly through each other while unfaded solids stay true occluders. Opacity 0 hides a part (also omitted from AR).
